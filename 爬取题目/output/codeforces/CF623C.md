...
Input
The first line of the input contains a single integer n (1 ≤ n ≤ 100 000) — the number of points marked on the plane. Each of the next n lines contains two integers x i and y i (- 10 8 ≤ x i, y i ≤ 10 8) — the coordinates of the i -th point. It is guaranteed that no two points coincide.
