...
Input
The first line contains four space-separated integers — x 1, x 2, a and b (x 1 ≠ x 2, a ≤ b, - 10 9 ≤ x 1, x 2, a, b ≤ 10 9) — coordinates of the points where the first and the second participant start, and the numbers that determine the players' moves, correspondingly.
