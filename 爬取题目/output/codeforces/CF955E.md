...
Input
The first line contains the number of icicles n (2 ≤ n ≤ 10 5). The next line contains n space-separated numbers a i (1 ≤ a i ≤ 10 5) — the distances from floor to icicles.
