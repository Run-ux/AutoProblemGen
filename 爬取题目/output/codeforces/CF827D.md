...
Input
The first line contains two integers n and m (2 ≤ n ≤ 2·10 5, n - 1 ≤ m ≤ 2·10 5), where n and m are the number of vertices and the number of edges in the graph, respectively. Each of the next m lines contains three integers u, v and c (1 ≤ v, u ≤ n, v ≠ u, 1 ≤ c ≤ 10 9) meaning that there is an edge between vertices u and v with weight c.
