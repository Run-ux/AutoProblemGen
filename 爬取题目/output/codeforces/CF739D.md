...
Input
The first line contains single integer n (1 ≤ n ≤ 300) — the number of vertices in the graph. Each of the next n lines contain two integers — precycle i (0 ≤ precycle i ≤ n - 1) and cycle i (1 ≤ cycle i ≤ n). There could be question marks instead of some of these values.
