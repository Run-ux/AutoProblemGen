...
Input
The first line contains two integers t and k (1 ≤ t, k ≤ 1000) — the number of segments and the distance between the numbers correspondingly. Next t lines contain pairs of integers l i and r i (1 ≤ l ≤ r ≤ 10 1000). All numbers are given without the leading zeroes. Numbers in each line are separated by exactly one space character.
