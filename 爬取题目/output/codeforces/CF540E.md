...
Input
The first line contains a single integer n (1 ≤ n ≤ 10 5) — the number of swap operations applied to the sequence. Each of the next n lines contains two integers a i and b i (1 ≤ a i, b i ≤ 10 9, a i ≠ b i) — the arguments of the swap operation.
