...
Input
The first line contains n and m (1 ≤ n, m ≤ 10 3) — size of the room. Next n lines goes, each contains m numbers a ij — Dima's notes: a ij = 1, if Dima was staying in the square (i, j) or was flying above it. Otherwise a ij = 0. At least one a ij equals 1.
