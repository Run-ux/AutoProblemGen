...
Input
The first line contains the single integer t (1 ≤ t ≤ 10 5) — the number of the King's visits. Each of the following t input lines contains four space-separated integers k i, l i, r i and p i (1 ≤ k i ≤ 10 6; 0 ≤ l i ≤ r i ≤ 10 18; 2 ≤ p i ≤ 10 9) — the numbers, chosen by the Great Mushroom King and the prime module, correspondingly. It is guaranteed that for all visits number p i is prime. Please do not use the %lld specifier to read or write 64-bit integers in С++. It is preferred to use the cin, cout streams or the %I64d specifier.
