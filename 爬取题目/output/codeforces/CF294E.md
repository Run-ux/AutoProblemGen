...
Input
The first line of the input contains an integer n denoting the number of cities in the empire, (2 ≤ n ≤ 5000). The next n - 1 lines each contains three integers a i, b i and w i showing that two cities a i and b i are connected using a road of length w i, (1 ≤ a i, b i ≤ n, a i ≠ b i, 1 ≤ w i ≤ 10 6).
