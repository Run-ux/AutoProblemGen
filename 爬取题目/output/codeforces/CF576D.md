...
Input
The first line contains two integers, n and m (2 ≤ n ≤ 150, 1 ≤ m ≤ 150) — the number of cities in the country and the number of flights the company provides. Next m lines contain numbers a i, b i, d i (1 ≤ a i, b i ≤ n, 0 ≤ d i ≤ 10 9), representing flight number i from city a i to city b i, accessible to only the clients who have made at least d i flights.
