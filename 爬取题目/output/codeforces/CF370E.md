...
Input
The first line contains integer n — the number of summer days (2 ≤ n ≤ 2·10 5). The second line contains n integers a 1, a 2, ... a n — the records in the diary in the order they were written (0 ≤ a i ≤ 10 5). If Vasya forgot to write the number of the book on the i -th day, then a i equals 0.
