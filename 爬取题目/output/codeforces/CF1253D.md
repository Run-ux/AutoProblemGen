...
In other words, in a harmonious graph, if from a node $l$ we can reach a node $r$ through edges ($l \lt r$), then we should able to reach nodes $(l+1), (l+2), \ldots, (r-1)$ too.
