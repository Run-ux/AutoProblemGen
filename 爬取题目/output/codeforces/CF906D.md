...
Input
First line of input contains two integers n (1 ≤ n ≤ 10 5) and m (1 ≤ m ≤ 10 9). Second line of input contains n integers w k (1 ≤ w k ≤ 10 9) which is the power of rocks that priests have. Third line of input contains single integer q (1 ≤ q ≤ 10 5) which is amount of queries from priests to you. k th of next q lines contains two integers l k and r k (1 ≤ l k ≤ r k ≤ n).
