...
Input
The first line contains two integers n, k (0 ≤ n ≤ 1000, 1 ≤ k ≤ 10 6) — carbon dioxide concentration the friends want and the number of Coke types. The second line contains k integers a 1, a 2, ..., a k (0 ≤ a i ≤ 1000) — carbon dioxide concentration of each type of Coke. Some Coke types can have same concentration.
