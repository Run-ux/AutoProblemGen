...
Input
The first line contains two integers n and m (1 ≤ n ≤ 20; 1 ≤ m ≤ 10 7; m is even). The next line contains n integers: a 0, a 1,..., a n - 1 (1 ≤ a i ≤ 10). The next line contains n integers: b 0, b 1,..., b n - 1 (1 ≤ b i ≤ 10). The numbers are separated by spaces.
