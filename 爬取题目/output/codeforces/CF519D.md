...
Input
The first line contains 26 integers x a, x b, ..., x z (- 10 5 ≤ x i ≤ 10 5) — the value assigned to letters a, b, c, ..., z respectively. The second line contains string s of length between 1 and 10 5 characters, consisting of Lating lowercase letters— the string for which you need to calculate the answer.
