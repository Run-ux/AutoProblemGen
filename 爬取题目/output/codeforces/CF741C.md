...
Input
The first line contains an integer n (1  ≤ n ≤  10 5) — the number of pairs of guests. The i -th of the next n lines contains a pair of integers a i and b i (1  ≤ a i, b i ≤  2 n) — the number of chair on which the boy in the i -th pair was sitting and the number of chair on which his girlfriend was sitting. It's guaranteed that there was exactly one person sitting on each chair.
