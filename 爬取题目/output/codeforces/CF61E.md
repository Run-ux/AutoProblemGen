...
Input
The first line of input contains a single number n (3 ≤ n ≤ 10 6) — the number of men in Roman army. Next line contains n different positive integers a i (1 ≤ i ≤ n, 1 ≤ a i ≤ 10 9) — powers of men in the Roman army.
