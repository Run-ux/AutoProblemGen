...
Input
The single line contains space-separated integers l and r (1 ≤ l ≤ r ≤ 10 18). Please, do not use the %lld specifier to read or write 64-bit integers in C++. It is preferred to use the cin, cout streams or the %I64d specifier.
