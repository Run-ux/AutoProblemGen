...
Input
The first line contains one integer N (1 ≤ N ≤ 500000). The second line contains N integer numbers B i, separated by single spaces. The third and the fourth lines contain sequences I i and R i in the same format. It is guaranteed that 0 ≤ B i, I i, R i ≤ 10 9.
