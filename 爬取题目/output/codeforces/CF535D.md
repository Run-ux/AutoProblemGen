...
Input
The first line contains two integers n and m, the length of s and the length of the subsequence Malekas wrote down (1 ≤ n ≤ 10 6 and 0 ≤ m ≤ n - | p | + 1). The second line contains string p (1 ≤ | p | ≤ n). The next line contains m space separated integers y 1, y 2, ..., y m, Malekas' subsequence (1 ≤ y 1 < y 2 < ... < y m ≤ n - | p | + 1).
