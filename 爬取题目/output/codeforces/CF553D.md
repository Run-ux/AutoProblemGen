...
Input
The first line of input contains three integers n, m, k (2  ≤ n ≤ 100 000, 1 ≤ m ≤ 100 000, 1 ≤ k ≤ n - 1). The second line of input contains k integers, representing the cities with fortresses. These cities will all be distinct. The next m lines contain the roads. The i -th of these lines will have 2 integers a i, b i (1 ≤ a i, b i ≤ n, a i ≠ b i). Every city will have at least one road adjacent to it. There is no more than one road between each pair of the cities.
