...
Input
The first line contains two integers m and n (2 ≤ m ≤ 10 9 + 7, 1 ≤ n ≤ 10 5, m is prime) — Timofey's favorite prime module and the length of the sequence. The second line contains n distinct integers a 1, a 2, ..., a n (0 ≤ a i < m) — the elements of the sequence.
