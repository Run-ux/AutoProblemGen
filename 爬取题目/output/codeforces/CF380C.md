...
Input
The first line contains a sequence of characters s 1, s 2, ..., s n (1 ≤ n ≤ 10 6) without any spaces. Each character is either a " (" or a ") ". The second line contains integer m (1 ≤ m ≤ 10 5) — the number of queries. Each of the next m lines contains a pair of integers. The i -th line contains integers l i, r i (1 ≤ l i ≤ r i ≤ n) — the description of the i -th query.
