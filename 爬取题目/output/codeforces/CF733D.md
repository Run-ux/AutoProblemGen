...
Input
The first line contains the integer n (1 ≤ n ≤ 10 5). n lines follow, in the i -th of which there are three integers a i, b i and c i (1 ≤ a i, b i, c i ≤ 10 9) — the lengths of edges of the i -th stone. Note, that two stones may have exactly the same sizes, but they still will be considered two different stones.
