...
Input
The first line of input contains a single integer k (1 ≤ k ≤ 10 5) — the number of elements in array Barney gave you. The second line contains k integers a 1, a 2, ..., a k (1 ≤ a i ≤ 10 18) — the elements of the array.
