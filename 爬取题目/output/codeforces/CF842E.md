...
Input
First line contains one integer number m — number of queries (1 ≤ m ≤ 3·10 5). Next m lines contain description of queries. i -th line (1 ≤ i ≤ m) describes the i -th level and contains an integer y i — the index of the parent-class of class with index i + 1 (1 ≤ y i ≤ i).
