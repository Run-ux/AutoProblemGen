...
Input
The first line of the input contains a single integer n (1 ≤ n ≤ 100 000) — the number of cards on the table. Each of the next n lines contains four integers a i, b i, c i, d i (0 ≤ a i, b i, c i, d i ≤ 10 9) — the characteristics of the corresponding card.
