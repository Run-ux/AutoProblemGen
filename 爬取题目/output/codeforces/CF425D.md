...
Input
The first line contains integer n (1 ≤ n ≤ 10 5). Each of the next n lines contains two integers x i, y i (0 ≤ x i, y i ≤ 10 5), the integers represent the coordinates of the i -th point. It is guaranteed that all the given points are distinct.
