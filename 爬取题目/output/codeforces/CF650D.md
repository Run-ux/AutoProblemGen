...
Input
The first line of the input contains two integers n and m (1 ≤ n, m ≤ 400 000) — the number of the trees in the forest and the number of Petya's assumptions, respectively. The following line contains n integers h i (1 ≤ h i ≤ 10 9) — the heights of trees according to Vasya. Each of the following m lines contains two integers a i and b i (1 ≤ a i ≤ n, 1 ≤ b i ≤ 10 9).
