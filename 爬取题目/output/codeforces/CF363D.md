...
Input
The first line of the input contains three integers n, m and a (1 ≤ n, m ≤ 10 5; 0 ≤ a ≤ 10 9). The second line contains the sequence of integers b 1, b 2, ..., b n (1 ≤ b i ≤ 10 4), where b i is the amount of the i -th boy's personal money. The third line contains the sequence of integers p 1, p 2, ..., p m (1 ≤ p j ≤ 10 9), where p j is the price for renting the j -th bike.
