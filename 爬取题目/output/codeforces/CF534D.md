...
Input
The first line contains integer n (1 ≤ n ≤ 2·10 5) — the number of students who came to CTOP. The next line contains n integers a 1, a 2, ..., a n (0 ≤ a i < n), where a i is the number of students with who the i -th student shook hands.
