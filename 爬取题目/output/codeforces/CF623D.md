...
Input
The first line of the input contains a single integer n (1 ≤ n ≤ 100) — the number of Misha's friends. The second line contains n integers p i (), giving the probability to catch the i -th friend in one particular round in percent.
