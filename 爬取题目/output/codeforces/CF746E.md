...
Input
The first line contains two integers n and m (2 ≤ n ≤ 2·10 5, 1 ≤ m ≤ 10 9) — the number of cards Eugeny has and the number of cards Nikolay has. It is guaranteed that n is even. The second line contains a sequence of n positive integers a 1, a 2, ..., a n (1 ≤ a i ≤ 10 9) — the numbers on Eugeny's cards.
