...
Input
The first line contains integer n (1 ≤ n ≤ 80000) — the number of tree nodes. Each of the following n - 1 lines contains a pair of integers u i and v i (1 ≤ u i, v i ≤ n; u i ≠ v i) — the i -th edge of the tree. It is guaranteed that the given graph is a tree.
