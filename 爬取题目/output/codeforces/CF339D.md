...
Input
The first line contains two integers n and m (1 ≤ n ≤ 17, 1 ≤ m ≤ 10 5). The next line contains 2 n integers a 1, a 2, ..., a 2 n (0 ≤ a i < 2 30). Each of the next m lines contains queries. The i -th line contains integers p i, b i (1 ≤ p i ≤ 2 n, 0 ≤ b i < 2 30) — the i -th query.
