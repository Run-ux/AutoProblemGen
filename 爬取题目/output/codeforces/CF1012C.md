...
Input
The first line of input contains the only integer n (1 ≤ n ≤ 5000)—the number of the hills in the sequence. Second line contains n integers a i (1 ≤ a i ≤ 100 000)—the heights of the hills in the sequence.
