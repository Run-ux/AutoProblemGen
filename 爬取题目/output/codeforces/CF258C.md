...
Input
The first line contains a single positive integer n (1 ≤ n ≤ 10 5) — the number of integers in the sequence a. The second line contains n space-separated integers a 1, a 2, ..., a n (1 ≤ a i ≤ 10 5) — sequence a.
