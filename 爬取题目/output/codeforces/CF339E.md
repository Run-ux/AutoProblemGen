...
Output
The first line should contain integer k (0 ≤ k ≤ 3) — the number of commads Xenia gave during the practice. In each of the next k lines print two integers. In the i -th line print numbers l i, r i (1 ≤ l i < r i ≤ n) — Xenia's i -th command during the practice. It is guaranteed that a solution exists. If there are several solutions, you are allowed to print any of them.
