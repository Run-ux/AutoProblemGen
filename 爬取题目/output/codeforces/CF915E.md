...
Input
The first line contains one integer n, and the second line — one integer q (1 ≤ n ≤ 10 9, 1 ≤ q ≤ 3·10 5) — the number of days left before the end of the term, and the number of orders, respectively. Then q lines follow, i -th line containing three integers l i, r i and k i representing i -th order (1 ≤ l i ≤ r i ≤ n, 1 ≤ k i ≤ 2).
