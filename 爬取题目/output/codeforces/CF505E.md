...
Input
The first line of the input contains four space-separated integers n, m, k and p (1 ≤ n ≤ 10 5, 1 ≤ m ≤ 5000, 1 ≤ k ≤ 10, 1 ≤ p ≤ 10 9). They represent the number of the bamboos in Mr. Kitayuta's garden, the duration of Mr. Kitayuta's fight in days, the maximum number of times that Mr. Kitayuta beat the bamboos during each day, and the power of Magic Hammer, respectively. The following n lines describe the properties of the bamboos. The i -th of them (1 ≤ i ≤ n) contains two space-separated integers h i and a i (0 ≤ h i ≤ 10 9, 1 ≤ a i ≤ 10 9), denoting the initial height and the growth rate of the i -th bamboo, respectively.
