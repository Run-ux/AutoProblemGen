...
Input
The first line contains a single integer m (1 ≤ m ≤ 31). The next line contains m distinct integers a 1, a 2, ..., a m (0 ≤ a i ≤ 30) — elements of the set S. It is guaranteed that all elements of the set are distinct.
