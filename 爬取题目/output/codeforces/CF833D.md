...
Input
The first line contains the number of nodes n (2 ≤ n ≤ 10 5). The next n - 1 lines contain four integers each, denoting the i -th thread of the cobweb: the nodes it connects u i, v i (1 ≤ u i ≤ n, 1 ≤ v i ≤ n), the clamminess of the thread x i (1 ≤ x ≤ 10 9 + 6), and the color of the thread c i (). The red color is denoted by 0, and the black color is denoted by 1.
