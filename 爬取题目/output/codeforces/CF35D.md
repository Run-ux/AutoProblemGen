...
Input
The first input line contains integers n and X (1 ≤ n ≤ 100, 1 ≤ X ≤ 10 4) — amount of days in DravDe’s dream and the total amount of food (in tons) that was there initially. The second line contains integers c i (1 ≤ c i ≤ 300). Numbers in the second line are divided by a space.
