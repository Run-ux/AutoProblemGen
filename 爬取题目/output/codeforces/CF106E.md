...
Input
The first line of the input file contains integer n — the number of planets (1 ≤ N ≤ 100). Each of the following n lines contains information about the planets. The i -th line contains three integers x i, y i, z i — the coordinates of the i -th planet (- 10 4 ≤ x i, y i, z i ≤ 10 4, 1 ≤ i ≤ n). No two planets coincide.
