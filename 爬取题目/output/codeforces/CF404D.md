...
Input
The first line contains sequence of characters without spaces s 1 s 2... s n (1 ≤ n ≤ 10 6), containing only characters " * ", " ? " and digits " 0 ", " 1 " or " 2 ". If character s i equals " * ", then the i -th cell of the field contains a bomb. If character s i equals " ? ", then Valera hasn't yet decided what to put in the i -th cell. Character s i, that is equal to a digit, represents the digit written in the i -th square.
