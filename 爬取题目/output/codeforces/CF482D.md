...
Input
The first line contains a single integer n (2 ≤ n ≤ 10 5) — the number of vertexes in the tree. The second line contains n - 1 integers p 2, p 3, ..., p n (1 ≤ p i < i). Number p i is the parent of vertex i.
