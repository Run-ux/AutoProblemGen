...
Input
The first line contains two integers n, k (1 ≤ n, k ≤ 3000) — the initial number of fools and the number of bullets for each fool. The second line contains n integers p 1, p 2, ..., p n (0 ≤ p i ≤ 100) — the given probabilities (in percent).
