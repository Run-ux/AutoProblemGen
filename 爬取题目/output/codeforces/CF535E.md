...
Input
The first line of input contains a single integer n (1 ≤ n ≤ 2 × 10 5). The next n lines contain the details of competitors. i -th line contains two integers s i and r i (1 ≤ s i, r i ≤ 10 4).
