...
Input
The first line contains two space-separated integers n, k (1 ≤ k ≤ n ≤ 4·10 5), showing how many numbers an array has and how many equal numbers the subarrays are required to have, correspondingly. The second line contains n space-separated integers a i (1 ≤ a i ≤ 10 9) — elements of the array.
