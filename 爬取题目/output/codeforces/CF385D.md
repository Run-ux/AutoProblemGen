...
Input
The first line contains three space-separated integers n, l, r (1 ≤ n ≤ 20;  - 10 5 ≤ l ≤ r ≤ 10 5). The i -th of the next n lines contain three space-separated integers x i, y i, a i ( - 1000 ≤ x i ≤ 1000; 1 ≤ y i ≤ 1000; 1 ≤ a i ≤ 90) — the floodlights' description. Note that two floodlights can be at the same point of the plane.
